...
\index{Euromillions}
\begin{figure}
\includegraphics[width=\hsize]{images/euromillions}
\caption{Besondere Gewinnchance in Euromillions}
\end{figure}
\begin{figure}
\begin{center}
\includegraphics[height=8cm]{images/euromillionsschein}
\end{center}
...
\begin{definition} Eine Ereignisalgebra $(\Omega,{\cal A})$ ist
...
ein Interval, innerhalb dessen sich ein Messwert befinden muss. Wir
...
\begin{figure}
\begin{center}
\includegraphics[width=\hsize]{images/aids-300}
\end{center}
