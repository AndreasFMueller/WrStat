...
\begin{teilaufgaben}
\item Geben Sie ein Interval für die Werte von $X$ an, die ``unverdächtig''
sind. Wählen Sie als Kriterium für ``unverdächtig'' ein Interval so, dass
die Anzahl $X$ bei einem ehrlichen Casino nur in 1\% der Fälle nicht
in dem Interval liegen würde.
...
weg vom Erwartungswert $np$ sind. Wir wählen die Schranken des Intervals
...
\right.
\]
Anzahlen im Interval $[35,61]$ sind also unverdächtig.
...
Wahl einer geeigneten Wahrscheinlichkeit für ein Interval ({\bf A}) 1 Punkt,
