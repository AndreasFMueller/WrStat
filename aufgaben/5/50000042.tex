...
\begin{loesung}
Die Anzahlen sind binomialverteilt, aber die grossen Summen können nur
schwer von Hand ausgerechnet werden, daher müssen Approximationen
verwendet werden.
\begin{teilaufgaben}
\item
...
Verzichtet man auf die Korrektur nach deMoivre-Laplace, ergibt sich
\[
\Phi\biggl(\frac{20-\mu}{\sigma}\biggr)
=
\Phi(0.52058)
=
0.69867
