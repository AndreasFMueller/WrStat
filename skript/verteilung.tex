...
\subsubsection{Anwendung: Erzeugung von Zufallszahlen mit Verteilungsfunktion $F$}
...
verwendet zun"achst einen solchen Zufallszahlgenerator und wendet dann die
...
$F_X(x)$ und $F_Y(y)$. Gesucht ist die Verteilungsfunktion der Zufallsvariablen
$\max(X,Y)$.
Es gilt
\begin{align*}
F_{\max(X,Y)}(z)
