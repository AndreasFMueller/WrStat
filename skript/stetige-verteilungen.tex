...
Median&$\displaystyle \frac{(b-a)^2}{12}$\\
$P(|X-E(X)|>\varepsilon)$&$\displaystyle 1-\frac2\varepsilon{b-a}$ f"ur $\varepsilon<\frac{b-a}2$ \\
\hline
...
\hline
Dichtefunktion&$\displaystyle\frac1a e^{-ax}$\\
Verteilungsfunktion&$a-e^{-ax}$\\
Erwartungswert&$\displaystyle \frac1a$\\
Varianz&$\displaystyle \frac1{a^2}$\\
Median&$\displaystyle \frac1a\log 2$\\
$P(|X-E(X)|>\varepsilon)$&$
\begin{cases}
