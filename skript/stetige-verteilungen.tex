...
\hline
Dichtefunktion&$\displaystyle a e^{-ax}$\\
...
\end{center}
\caption{Verteilungsfunktion (oben) und Dichtefunktion (unten) der Exponentialverteilung
...
$\displaystyle
\begin{cases}
\frac{\alpha-1}{x_{\min}^{1-\alpha}}x^{-\alpha}&\qquad x>x_{\text{min}}\\
0&\qquad\text{sonst}
\end{cases}
$
\end{minipage}
