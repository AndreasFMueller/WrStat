...
\input{8-filter/zweiquellen.tex}
\input{8-filter/wiener.tex}
\input{8-filter/einfuehrung.tex}
\input{8-filter/problemstellung.tex}
\input{8-filter/loesung.tex}
\input{8-filter/positionsmessung.tex}
\input{8-filter/hoehenmesser.tex}
