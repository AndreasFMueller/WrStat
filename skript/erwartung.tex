...
der F"alle gewinnen, in der anderen H"alfte verlieren. Im Mittel
...
Im Roulette gibt es aber weitere Spielm"oglichkeiten. Man kann zum Beispiel
auf rot setzen. Wie gross ist der erwartete Gewinn in diesem Fall?
...
ist dazu notwendig, dass $G$ gross wird. Da nur die H"alfte der
Einzahlungen "uberhaupt wieder zur Auszahlung gelangt, ist dies nur
m"oglich, wenn der Jackpot gross ist. Ein grosser Jackpot zieht nat"urlich
...
$A\subset\Omega$ haben. Im Beispiel des Lottos sind $A$ die Zahlen, die
...
Wiederholungen. Um den Fehler zu halbieren, muss die Anzahl der Versuche
vervierfacht werden.
\label{fehlerabnahme}}
\end{figure}
